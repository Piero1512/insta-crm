  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Control de prospección, edición y protocolo estricto 4+4
              </p>
            </div>
            <button
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm mb-6 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Buscar por cliente, tel, zip..."
                  value={searchQuery}
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <h3 className="font-bold text-slate-800 text-base">Bandeja de Prospectos</h3>
      ...
      <ConfirmModal
        ...
        message={`Estás a punto de eliminar permanentemente el lead de "${leadToDelete?.client_name}". Esta acción borrará su historial de llamadas y no se puede deshacer.`}
